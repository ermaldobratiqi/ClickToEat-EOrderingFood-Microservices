...
using ClickToEat.Services.OrderAPI.Messages;
...
namespace ClickToEat.Services.OrderAPI.Messaging
{
    public class AzureServiceBusConsumer : IAzureServiceBusConsumer
    {
        ...
        public AzureServiceBusConsumer(OrderRepository orderRepository, IConfiguration configuration, IMessageBus messageBus)
        {
            ...
            orderUpdatePaymentStatusProcesor = client.CreateProcessor(orderUpdatePaymentResultTopic, subscriptionCheckOut);
        }
        ...
        private async Task OnCheckOutMessageReceived(ProcessMessageEventArgs args)
        {
            ...
            OrderHeader orderHeader = new()
            {
                ...
                Address = checkoutHeaderDto.Address
            };
